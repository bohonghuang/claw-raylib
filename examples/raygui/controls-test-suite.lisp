            ...
            (loop :until (cbool-value exit-window)
                  :do (setf (cbool-value exit-window) (raylib:window-should-close))
                      ...
                      (raylib:with-drawing
                        ...
                        (raygui:panel (raylib:make-rectangle :x 320.0 :y 25.0 :width 225.0 :height 30.0) "Panel Info")
                        (raygui:color-picker (raylib:make-rectangle :x 320.0 :y 185.0 :width 225.0 :height 140.0) (null-pointer) color-picker-value)
                        ...
                        (let ((mouse-cell (raylib:make-vector2)))
                          (raygui:grid
                           ...
                           (null-pointer) 20.0 2 mouse-cell))
                        (raygui:status-bar
