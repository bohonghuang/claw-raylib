;; Generated by :claw at 2024-11-19T13:35:20.338134Z
...
(defparameter raylib::+get-mouse-ray+ nil)
...
(defparameter raylib::+raylib-version+ "5.5")

(defparameter raylib::+raylib-version-major+ 5)

(defparameter raylib::+raylib-version-minor+ 5)
...
(cffi:defcenum (raylib::|C:@EA@FONT-TYPE| :unsigned-int)
               "/usr/include/raylib.h:890:9"
               (:default 0)
               (:bitmap 1)
               (:sdf 2))

(cffi:defcenum (raylib::|C:@EA@GAMEPAD-AXIS| :unsigned-int)
               "/usr/include/raylib.h:747:9"
               (:left-x 0)
               (:left-y 1)
               (:right-x 2)
               (:right-y 3)
...
(declaim (inline raylib::check-collision-circle-line))

(cffi:defcfun ("__claw_CheckCollisionCircleLine"
               raylib::check-collision-circle-line)
              :bool
...
(declaim (inline raylib::color-is-equal))

(cffi:defcfun ("__claw_ColorIsEqual" raylib::color-is-equal)
              :bool
              (raylib::col1 (:pointer raylib::color))
              (raylib::col2 (:pointer raylib::color)))

(declaim (inline raylib::color-lerp))

(cffi:defcfun ("__claw_ColorLerp" raylib::color-lerp)
              (:pointer raylib::color)
              (raylib::%%claw-result- (:pointer raylib::color))
...
(declaim (inline raylib::compute-crc32))

(cffi:defcfun ("ComputeCRC32" raylib::compute-crc32)
              :unsigned-int
              (raylib::data (:pointer :unsigned-char))
              (raylib::data-size :int))

(declaim (inline raylib::compute-md5))

(cffi:defcfun ("ComputeMD5" raylib::compute-md5)
              (:pointer :unsigned-int)
              (raylib::data (:pointer :unsigned-char))
              (raylib::data-size :int))

(declaim (inline raylib::compute-sha1))

(cffi:defcfun ("ComputeSHA1" raylib::compute-sha1)
              (:pointer :unsigned-int)
              (raylib::data (:pointer :unsigned-char))
              (raylib::data-size :int))
...
(cffi:defcstruct (raylib::mesh :size 68)
                 ...
                 (raylib::bone-matrices (:pointer raylib::matrix)
                  :offset 52)
                 (raylib::bone-count :int :offset 56)
                 (raylib::vao-id :unsigned-int :offset 60)
                 (raylib::vbo-id (:pointer :unsigned-int) :offset 64))
...
(declaim (inline raylib::draw-model-points))

(cffi:defcfun ("__claw_DrawModelPoints" raylib::draw-model-points)
              :void
              (raylib::model (:pointer raylib::model))
              (raylib::position (:pointer raylib::vector3))
              (raylib::scale :float)
...
(declaim (inline raylib::draw-model-points-ex))

(cffi:defcfun ("__claw_DrawModelPointsEx"
               raylib::draw-model-points-ex)
              :void
              (raylib::model (:pointer raylib::model))
              (raylib::position (:pointer raylib::vector3))
              (raylib::rotation-axis (:pointer raylib::vector3))
...
(cffi:defcfun ("__claw_DrawRectangleGradientEx"
              ...
              :void
              (raylib::rec (:pointer raylib::rectangle))
              (raylib::top-left (:pointer raylib::color))
              (raylib::bottom-left (:pointer raylib::color))
              (raylib::top-right (:pointer raylib::color))
              (raylib::bottom-right (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawRectangleGradientH"
              ...
              (raylib::width :int)
              (raylib::height :int)
              (raylib::left (:pointer raylib::color))
              (raylib::right (:pointer raylib::color)))
...
(cffi:defcfun ("__claw_DrawRectangleGradientV"
              ...
              (raylib::width :int)
              (raylib::height :int)
              (raylib::top (:pointer raylib::color))
              (raylib::bottom (:pointer raylib::color)))
...
(declaim (inline raylib::draw-rectangle-rounded-lines-ex))

(cffi:defcfun ("__claw_DrawRectangleRoundedLinesEx"
...
(declaim (inline raylib::export-mesh-as-code))

(cffi:defcfun ("__claw_ExportMeshAsCode" raylib::export-mesh-as-code)
              :bool
              (raylib::mesh (:pointer raylib::mesh))
              (raylib::file-name :string))
...
(declaim (inline raylib::get-clipboard-image))

(cffi:defcfun ("__claw_cE3AE40FE40GetClipboardImage"
               raylib::get-clipboard-image)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image)))
...
(declaim (inline raylib::get-screen-to-world-ray))

(cffi:defcfun ("__claw_GetScreenToWorldRay"
               raylib::get-screen-to-world-ray)
              (:pointer raylib::ray)
              (raylib::%%claw-result- (:pointer raylib::ray))
              (raylib::position (:pointer raylib::vector2))
              (raylib::camera (:pointer raylib::camera)))

(declaim (inline raylib::get-screen-to-world-ray-ex))

(cffi:defcfun ("__claw_GetScreenToWorldRayEx"
               raylib::get-screen-to-world-ray-ex)
              (:pointer raylib::ray)
              (raylib::%%claw-result- (:pointer raylib::ray))
              (raylib::position (:pointer raylib::vector2))
              (raylib::camera (:pointer raylib::camera))
...
(declaim (inline raylib::get-shapes-texture))

(cffi:defcfun ("__claw_cE3AE40FE40GetShapesTexture"
               raylib::get-shapes-texture)
              (:pointer raylib::texture-2d)
              (raylib::%%claw-result- (:pointer raylib::texture-2d)))

(declaim (inline raylib::get-shapes-texture-rectangle))

(cffi:defcfun ("__claw_cE3AE40FE40GetShapesTextureRectangle"
               raylib::get-shapes-texture-rectangle)
              (:pointer raylib::rectangle)
              (raylib::%%claw-result- (:pointer raylib::rectangle)))
...
(declaim (inline raylib::image-draw-line-ex))

(cffi:defcfun ("__claw_ImageDrawLineEx" raylib::image-draw-line-ex)
              :void
              (raylib::dst (:pointer raylib::image))
...
(declaim (inline raylib::image-draw-triangle))

(cffi:defcfun ("__claw_ImageDrawTriangle"
               raylib::image-draw-triangle)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2))
...
(declaim (inline raylib::image-draw-triangle-ex))

(cffi:defcfun ("__claw_ImageDrawTriangleEx"
               raylib::image-draw-triangle-ex)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2))
              (raylib::v3 (:pointer raylib::vector2))
              (raylib::c1 (:pointer raylib::color))
              (raylib::c2 (:pointer raylib::color))
              (raylib::c3 (:pointer raylib::color)))

(declaim (inline raylib::image-draw-triangle-fan))

(cffi:defcfun ("__claw_ImageDrawTriangleFan"
               raylib::image-draw-triangle-fan)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::points (:pointer raylib::vector2))
              (raylib::point-count :int)
...
(declaim (inline raylib::image-draw-triangle-lines))

(cffi:defcfun ("__claw_ImageDrawTriangleLines"
               raylib::image-draw-triangle-lines)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2))
...
(declaim (inline raylib::image-draw-triangle-strip))

(cffi:defcfun ("__claw_ImageDrawTriangleStrip"
               raylib::image-draw-triangle-strip)
              :void
              (raylib::dst (:pointer raylib::image))
              (raylib::points (:pointer raylib::vector2))
              (raylib::point-count :int)
...
(declaim (inline raylib::image-from-channel))

(cffi:defcfun ("__claw_ImageFromChannel" raylib::image-from-channel)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::image (:pointer raylib::image))
              (raylib::selected-channel :int))
...
(declaim (inline raylib::image-kernel-convolution))

(cffi:defcfun ("ImageKernelConvolution"
               raylib::image-kernel-convolution)
              :void
              (raylib::image (:pointer raylib::image))
              (raylib::kernel (:pointer :float))
              (raylib::kernel-size :int))
...
(declaim (inline raylib::is-audio-stream-valid))

(cffi:defcfun ("__claw_IsAudioStreamValid"
               raylib::is-audio-stream-valid)
              :bool
              (raylib::stream (:pointer raylib::audio-stream)))
...
(declaim (inline raylib::is-file-name-valid))

(cffi:defcfun ("IsFileNameValid" raylib::is-file-name-valid)
              :bool
              (raylib::file-name :string))

(declaim (inline raylib::is-font-valid))

(cffi:defcfun ("__claw_IsFontValid" raylib::is-font-valid)
              :bool
              (raylib::font (:pointer raylib::font)))
...
(declaim (inline raylib::is-image-valid))

(cffi:defcfun ("__claw_IsImageValid" raylib::is-image-valid)
              :bool
              (raylib::image (:pointer raylib::image)))
...
(declaim (inline raylib::is-material-valid))

(cffi:defcfun ("__claw_IsMaterialValid" raylib::is-material-valid)
              :bool
              (raylib::material (:pointer raylib::material)))
...
(declaim (inline raylib::is-model-valid))

(cffi:defcfun ("__claw_IsModelValid" raylib::is-model-valid)
              :bool
              (raylib::model (:pointer raylib::model)))
...
(declaim (inline raylib::is-music-valid))

(cffi:defcfun ("__claw_IsMusicValid" raylib::is-music-valid)
              :bool
              (raylib::music (:pointer raylib::music)))
...
(declaim (inline raylib::is-render-texture-valid))

(cffi:defcfun ("__claw_IsRenderTextureValid"
               raylib::is-render-texture-valid)
              :bool
              (raylib::target (:pointer raylib::render-texture-2d)))

(declaim (inline raylib::is-shader-valid))

(cffi:defcfun ("__claw_IsShaderValid" raylib::is-shader-valid)
              :bool
              (raylib::shader (:pointer raylib::shader)))
...
(declaim (inline raylib::is-sound-valid))

(cffi:defcfun ("__claw_IsSoundValid" raylib::is-sound-valid)
              :bool
              (raylib::sound (:pointer raylib::sound)))

(declaim (inline raylib::is-texture-valid))

(cffi:defcfun ("__claw_IsTextureValid" raylib::is-texture-valid)
              :bool
              (raylib::texture (:pointer raylib::texture-2d)))

(declaim (inline raylib::is-wave-valid))

(cffi:defcfun ("__claw_IsWaveValid" raylib::is-wave-valid)
              :bool
              (raylib::wave (:pointer raylib::wave)))
...
(declaim (inline raylib::load-image-anim-from-memory))

(cffi:defcfun ("__claw_LoadImageAnimFromMemory"
               raylib::load-image-anim-from-memory)
              (:pointer raylib::image)
              (raylib::%%claw-result- (:pointer raylib::image))
              (raylib::file-type :string)
              (raylib::file-data (:pointer :unsigned-char))
...
(cffi:defcstruct (raylib::vr-device-info :size 60)
                 ...
                 (raylib::eye-to-screen-distance :float :offset 16)
                 (raylib::lens-separation-distance :float :offset 20)
                 (raylib::interpupillary-distance :float :offset 24)
...
(declaim (inline raylib::make-directory))

(cffi:defcfun ("MakeDirectory" raylib::make-directory)
              :int
              (raylib::dir-path :string))
...
(declaim (inline raylib::matrix-decompose))

(cffi:defcfun ("__claw_MatrixDecompose" raylib::matrix-decompose)
              :void
              (raylib::mat (:pointer raylib::matrix))
              (raylib::translation (:pointer raylib::vector3))
              (raylib::rotation (:pointer raylib::quaternion))
              (raylib::scale (:pointer raylib::vector3)))
...
(declaim (inline raylib::quaternion-cubic-hermite-spline))

(cffi:defcfun ("__claw_QuaternionCubicHermiteSpline"
               raylib::quaternion-cubic-hermite-spline)
              (:pointer raylib::quaternion)
              (raylib::%%claw-result- (:pointer raylib::quaternion))
              (raylib::q1 (:pointer raylib::quaternion))
              (raylib::out-tangent1 (:pointer raylib::quaternion))
              (raylib::q2 (:pointer raylib::quaternion))
              (raylib::in-tangent2 (:pointer raylib::quaternion))
              (raylib::t :float))
...
(declaim (inline raylib::set-gamepad-vibration))

(cffi:defcfun ("SetGamepadVibration" raylib::set-gamepad-vibration)
              :void
              (raylib::gamepad :int)
              (raylib::left-motor :float)
              (raylib::right-motor :float)
              (raylib::duration :float))
...
(declaim (inline raylib::text-to-camel))

(cffi:defcfun ("TextToCamel" raylib::text-to-camel)
              :string
              (raylib::text :string))

(declaim (inline raylib::text-to-float))

(cffi:defcfun ("TextToFloat" raylib::text-to-float)
              :float
              (raylib::text :string))
...
(declaim (inline raylib::text-to-snake))

(cffi:defcfun ("TextToSnake" raylib::text-to-snake)
              :string
              (raylib::text :string))
...
(cffi:defcfun ("__claw_UnloadAutomationEventList"
...
(declaim (inline raylib::update-model-animation-bones))

(cffi:defcfun ("__claw_UpdateModelAnimationBones"
               raylib::update-model-animation-bones)
              :void
              (raylib::model (:pointer raylib::model))
              (raylib::anim (:pointer raylib::model-animation))
              (raylib::frame :int))
...
(declaim (inline raylib::vector2-max))

(cffi:defcfun ("__claw_Vector2Max" raylib::vector2-max)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))

(declaim (inline raylib::vector2-min))

(cffi:defcfun ("__claw_Vector2Min" raylib::vector2-min)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v1 (:pointer raylib::vector2))
              (raylib::v2 (:pointer raylib::vector2)))
...
(declaim (inline raylib::vector2-refract))

(cffi:defcfun ("__claw_Vector2Refract" raylib::vector2-refract)
              (:pointer raylib::vector2)
              (raylib::%%claw-result- (:pointer raylib::vector2))
              (raylib::v (:pointer raylib::vector2))
              (raylib::n (:pointer raylib::vector2))
              (raylib::r :float))
...
(declaim (inline raylib::vector3-cubic-hermite))

(cffi:defcfun ("__claw_Vector3CubicHermite"
               raylib::vector3-cubic-hermite)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v1 (:pointer raylib::vector3))
              (raylib::tangent1 (:pointer raylib::vector3))
              (raylib::v2 (:pointer raylib::vector3))
              (raylib::tangent2 (:pointer raylib::vector3))
              (raylib::amount :float))
...
(declaim (inline raylib::vector3-move-towards))

(cffi:defcfun ("__claw_Vector3MoveTowards"
               raylib::vector3-move-towards)
              (:pointer raylib::vector3)
              (raylib::%%claw-result- (:pointer raylib::vector3))
              (raylib::v (:pointer raylib::vector3))
              (raylib::target (:pointer raylib::vector3))
...
(declaim (inline raylib::vector4-add))

(cffi:defcfun ("__claw_Vector4Add" raylib::vector4-add)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-add-value))

(cffi:defcfun ("__claw_Vector4AddValue" raylib::vector4-add-value)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4))
              (raylib::add :float))

(declaim (inline raylib::vector4-distance))

(cffi:defcfun ("__claw_Vector4Distance" raylib::vector4-distance)
              :float
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-distance-sqr))

(cffi:defcfun ("__claw_Vector4DistanceSqr"
               raylib::vector4-distance-sqr)
              :float
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-divide))

(cffi:defcfun ("__claw_Vector4Divide" raylib::vector4-divide)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-dot-product))

(cffi:defcfun ("__claw_Vector4DotProduct"
               raylib::vector4-dot-product)
              :float
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-equals))

(cffi:defcfun ("__claw_Vector4Equals" raylib::vector4-equals)
              :int
              (raylib::p (:pointer raylib::vector4))
              (raylib::q (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-invert))

(cffi:defcfun ("__claw_Vector4Invert" raylib::vector4-invert)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-length))

(cffi:defcfun ("__claw_Vector4Length" raylib::vector4-length)
              :float
              (raylib::v (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-length-sqr))

(cffi:defcfun ("__claw_Vector4LengthSqr" raylib::vector4-length-sqr)
              :float
              (raylib::v (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-lerp))

(cffi:defcfun ("__claw_Vector4Lerp" raylib::vector4-lerp)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4))
...
(declaim (inline raylib::vector4-max))

(cffi:defcfun ("__claw_Vector4Max" raylib::vector4-max)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-min))

(cffi:defcfun ("__claw_Vector4Min" raylib::vector4-min)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-move-towards))

(cffi:defcfun ("__claw_Vector4MoveTowards"
               raylib::vector4-move-towards)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4))
              (raylib::target (:pointer raylib::vector4))
              (raylib::max-distance :float))

(declaim (inline raylib::vector4-multiply))

(cffi:defcfun ("__claw_Vector4Multiply" raylib::vector4-multiply)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-negate))

(cffi:defcfun ("__claw_Vector4Negate" raylib::vector4-negate)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-normalize))

(cffi:defcfun ("__claw_Vector4Normalize" raylib::vector4-normalize)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-one))

(cffi:defcfun ("__claw_cE3AE40FE40Vector4One" raylib::vector4-one)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-scale))

(cffi:defcfun ("__claw_Vector4Scale" raylib::vector4-scale)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4))
              (raylib::scale :float))

(declaim (inline raylib::vector4-subtract))

(cffi:defcfun ("__claw_Vector4Subtract" raylib::vector4-subtract)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v1 (:pointer raylib::vector4))
              (raylib::v2 (:pointer raylib::vector4)))

(declaim (inline raylib::vector4-subtract-value))

(cffi:defcfun ("__claw_Vector4SubtractValue"
               raylib::vector4-subtract-value)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4))
              (raylib::v (:pointer raylib::vector4))
              (raylib::add :float))

(declaim (inline raylib::vector4-zero))

(cffi:defcfun ("__claw_cE3AE40FE40Vector4Zero" raylib::vector4-zero)
              (:pointer raylib::vector4)
              (raylib::%%claw-result- (:pointer raylib::vector4)))
...
(cffi:defcfun ("WaveCrop" raylib::wave-crop)
              :void
              (raylib::wave (:pointer raylib::wave))
              (raylib::init-frame :int)
              (raylib::final-frame :int))
...
(cffi:defcfun ("__claw_scalblnl" raylib::scalblnl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%n :long))
...
(cffi:defcfun ("__claw_scalbnl" raylib::scalbnl)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::%%x (:pointer raylib::long-double))
              (raylib::%%n :int))
...
(cffi:defcfun ("__claw_cE3AE40FE40tgammal" raylib::tgammal)
              (:pointer raylib::long-double)
              (raylib::%%claw-result- (:pointer raylib::long-double))
              (raylib::arg0 (:pointer raylib::long-double)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'raylib::vector4-min :raylib)
  ...
  (export 'raylib::vector4-normalize :raylib)
  ...
  (export 'raylib::get-screen-to-world-ray :raylib)
  ...
  (export 'raylib::vector4-move-towards :raylib)
  ...
  (export 'raylib::image-from-channel :raylib)
  ...
  (export 'raylib::is-font-valid :raylib)
  ...
  (export 'raylib::is-audio-stream-valid :raylib)
  ...
  (export 'raylib::image-draw-triangle-lines :raylib)
  ...
  (export 'raylib::image-draw-line-ex :raylib)
  ...
  (export 'raylib::vector2-refract :raylib)
  ...
  (export 'raylib::image-draw-triangle-strip :raylib)
  ...
  (export 'raylib::vector4-scale :raylib)
  (export 'raylib::draw-text :raylib)
  (export 'raylib::vector2-min :raylib)
  ...
  (export 'raylib::color-is-equal :raylib)
  (export 'raylib::text-copy :raylib)
  (export 'raylib::get-camera-matrix-2d :raylib)
  (export 'raylib::update-model-animation-bones :raylib)
  ...
  (export 'raylib::vector4-subtract-value :raylib)
  ...
  (export 'raylib::is-wave-valid :raylib)
  ...
  (export 'raylib::is-texture-valid :raylib)
  ...
  (export 'raylib::text-to-snake :raylib)
  ...
  (export 'raylib::is-model-valid :raylib)
  ...
  (export 'raylib::get-shapes-texture-rectangle :raylib)
  ...
  (export 'raylib::draw-model-points-ex :raylib)
  ...
  (export 'raylib::compute-sha1 :raylib)
  ...
  (export 'raylib::vector4-distance-sqr :raylib)
  ...
  (export 'raylib::vector4-lerp :raylib)
  ...
  (export 'raylib::vector2-max :raylib)
  ...
  (export 'raylib::vector4-divide :raylib)
  ...
  (export 'raylib::vector4-zero :raylib)
  ...
  (export 'raylib::is-music-valid :raylib)
  ...
  (export 'raylib::compute-md5 :raylib)
  ...
  (export 'raylib::vector3-move-towards :raylib)
  ...
  (export 'raylib::compute-crc32 :raylib)
  ...
  (export 'raylib::load-image-anim-from-memory :raylib)
  (export 'raylib::+darkbrown+ :raylib)
  (export 'raylib::get-screen-to-world-ray-ex :raylib)
  ...
  (export 'raylib::image-draw-triangle-ex :raylib)
  ...
  (export 'raylib::vector4-one :raylib)
  (export 'raylib::quaternion-cubic-hermite-spline :raylib)
  ...
  (export 'raylib::vector4-subtract :raylib)
  ...
  (export 'raylib::set-gamepad-vibration :raylib)
  ...
  (export 'raylib::get-clipboard-image :raylib)
  ...
  (export 'raylib::image-draw-triangle :raylib)
  ...
  (export 'raylib::vector4-max :raylib)
  (export 'raylib::m11 :raylib)
  (export 'raylib::+mouse-middle-button+ :raylib)
  (export 'raylib::is-material-valid :raylib)
  ...
  (export 'raylib::vector4-dot-product :raylib)
  ...
  (export 'raylib::vector3-cubic-hermite :raylib)
  ...
  (export 'raylib::vector4-add-value :raylib)
  ...
  (export 'raylib::vector4-length :raylib)
  ...
  (export 'raylib::vector4-distance :raylib)
  ...
  (export 'raylib::vector4-negate :raylib)
  ...
  (export 'raylib::text-to-float :raylib)
  ...
  (export 'raylib::matrix-decompose :raylib)
  ...
  (export 'raylib::is-render-texture-valid :raylib)
  ...
  (export 'raylib::image-draw-triangle-fan :raylib)
  ...
  (export 'raylib::is-shader-valid :raylib)
  (export 'raylib::decompress-data :raylib)
  (export 'raylib::mipmaps :raylib)
  (export 'raylib::vector4-equals :raylib)
  ...
  (export 'raylib::draw-model-points :raylib)
