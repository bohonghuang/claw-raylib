...
(defparameter rlgl::+win32+ nil)

(defparameter rlgl::+win64+ nil)

(defparameter rlgl::+winnt+ nil)

(defparameter rlgl::+%win32+ 1)

(defparameter rlgl::+%win64+ 1)

(defparameter rlgl::+%cdecl+ nil)

(defparameter rlgl::+%fastcall+ nil)

(defparameter rlgl::+%pascal+ nil)

(defparameter rlgl::+%stdcall+ nil)

(defparameter rlgl::+%thiscall+ nil)
...
(cffi:defcfun ("__claw_cE3AE40FE40rlGetMatrixModelview"
...
(cffi:defcfun ("__claw_cE3AE40FE40rlGetMatrixProjection"
...
(cffi:defcfun ("__claw_rlGetMatrixProjectionStereo"
...
(cffi:defcfun ("__claw_cE3AE40FE40rlGetMatrixTransform"
...
(cffi:defcfun ("__claw_rlGetMatrixViewOffsetStereo"
...
(cffi:defcfun ("__claw_rlLoadRenderBatch" rlgl::load-render-batch)
...
(cffi:defcfun ("__claw_rlSetMatrixModelview"
...
(cffi:defcfun ("__claw_rlSetMatrixProjection"
...
(cffi:defcfun ("__claw_rlSetMatrixProjectionStereo"
...
(cffi:defcfun ("__claw_rlSetMatrixViewOffsetStereo"
...
(cffi:defcfun ("__claw_rlSetUniformMatrix" rlgl::set-uniform-matrix)
              :void
              (rlgl::loc-index :int)
              (rlgl::mat (:pointer rlgl::matrix)))
...
(cffi:defcfun ("__claw_rlUnloadRenderBatch"
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'rlgl::+%pascal+ :rlgl)
  (export 'rlgl::update-shader-buffer :rlgl)
  (export 'rlgl::+%win64+ :rlgl)
  (export 'rlgl::m2 :rlgl)
  (export 'rlgl::+win32+ :rlgl)
