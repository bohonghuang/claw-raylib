...
(defparameter rlgl::+%ilp32+ 1)

(defparameter rlgl::+bool+ nil)

(defparameter rlgl::+false+ 0)

(defparameter rlgl::+i386+ nil)

(defparameter rlgl::+linux+ nil)

(defparameter rlgl::+true+ 1)

(defparameter rlgl::+unix+ nil)
...
(cffi:defcstruct (rlgl::vertex-buffer :size 48)
                 (rlgl::element-count :int :offset 0)
                 (rlgl::vertices (:pointer :float) :offset 4)
                 (rlgl::texcoords (:pointer :float) :offset 8)
                 (rlgl::normals (:pointer :float) :offset 12)
                 (rlgl::colors (:pointer :unsigned-char) :offset 16)
                 (rlgl::indices (:pointer :unsigned-int) :offset 20)
                 (rlgl::vao-id :unsigned-int :offset 24)
                 (rlgl::vbo-id :unsigned-int :count 5 :offset 28))
...
(cffi:defcstruct (rlgl::render-batch :size 24)
                 (rlgl::buffer-count :int :offset 0)
                 (rlgl::current-buffer :int :offset 4)
                 (rlgl::vertex-buffer (:pointer rlgl::vertex-buffer)
                  :offset 8)
                 (rlgl::draws (:pointer rlgl::draw-call) :offset 12)
                 (rlgl::draw-counter :int :offset 16)
                 (rlgl::current-depth :float :offset 20))
