...
(cffi:defcstruct (rlgl::vertex-buffer :size 40)
                 (rlgl::element-count :int :offset 0)
                 (rlgl::vertices (:pointer :float) :offset 4)
                 (rlgl::texcoords (:pointer :float) :offset 8)
                 (rlgl::colors (:pointer :unsigned-char) :offset 12)
                 (rlgl::indices (:pointer :unsigned-int) :offset 16)
                 (rlgl::vao-id :unsigned-int :offset 20)
                 (rlgl::vbo-id :unsigned-int :count 4 :offset 24))
